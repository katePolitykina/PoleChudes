...
if position > 0 then
    ...
    begin
    r := random(3);
    if r = 0 then writeln('Да ладно!')
    else if r = 1 then writeln('Увы и ах')
    else if r = 2 then writeln('Что вы говорите!');
...
writeln('Вы выиграли АААААААААААААВТОМОБИЛЬ');
writeln('Победил ', player, '-й игрок');
writeln('Слово ', show);
writeln('Очки ', score[player]);
readln;
end.
